 ...
 * @author Vika$h
 */
public class FoursecController implements Initializable {
    ...
    ObservableList<String> list = FXCollections.observableArrayList("IT","ECE");
